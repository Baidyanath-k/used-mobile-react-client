...
const SymphonyDetails = () => {
    const symphonyProduct = useLoaderData();
    const { Color, condition_type, descreption, facility, img, location, orginal_price, posted_time, resale_price, seller_name, title, years_of_use } = symphonyProduct;
    return (
